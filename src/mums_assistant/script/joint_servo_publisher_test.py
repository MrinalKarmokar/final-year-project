...
class MumsAssistantArm:
    ...
    def __init__(self):
        ...
        rospy.loginfo('\033[94m' + " >>> Join Servo Publisher init done." + '\033[0m')
    ...
    def joint_state_pub_servo(self):
        ...
        print(f">>>> Publishing Data to DOFS arm")
        dofs = Dofs()
        dofs.joint1 = int((list_joint_val[0])*180/3.14)
        dofs.joint2 = int((list_joint_val[1])*180/3.14)
        dofs.joint3 = int((list_joint_val[2])*180/3.14)
        dofs.joint4 = int((list_joint_val[3])*180/3.14)
        dofs.joint5 = int((list_joint_val[4])*180/3.14)
        self.pub.publish(dofs)

        rospy.loginfo('\033[94m' + "\nJoint Values: \n" +
                      "joint_1: {}\n".format(int(list_joint_val[0]*180/3.14)) +
                      "joint_2: {}\n".format(int(list_joint_val[1]*180/3.14)) +
                      "joint_3: {}\n".format(int(list_joint_val[2]*180/3.14)) +
                      "joint_4: {}\n".format(int(list_joint_val[3]*180/3.14)) +
                      "joint_5: {}\n".format(int(list_joint_val[4]*180/3.14)) +
                      '\033[0m')
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        ma.joint_state_pub_servo()
        mag.joint_state_pub_servo()
    del ma
